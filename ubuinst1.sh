...
wget https://raw.githubusercontent.com/pedrolpb2/painel-web/master/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/pedrolpb2/painel-web/master/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/pedrolpb2/painel-web/master/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/pedrolpb2/painel-web/master/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/pedrolpb2/painel-web/master/whatsapp.sh > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/pedrolpb2/painel-web/master/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/pedrolpb2/painel-web/master/chave") &>/dev/null
