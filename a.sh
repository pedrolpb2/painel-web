...
wget https://raw.githubusercontent.com/pedrolpb2/painel-web/main/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/pedrolpb2/painel-web/main/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/pedrolpb2/painel-web/main/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/pedrolpb2/painel-web/main/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/pedrolpb2/painel-web/main/whatsapp.sh > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/pedrolpb2/painel-web/main/gestorssh.zip > /dev/null 2>&1
